...
* [0.18.1](https://hub.docker.com/r/11notes/beszel/tags?name=0.18.1)
...
# REGISTRIES ☁️
```
docker pull 11notes/beszel:0.18.1
docker pull ghcr.io/11notes/beszel:0.18.1
docker pull quay.io/11notes/beszel:0.18.1
```
...
*created 12.01.2026, 06:25:55 (CET)*