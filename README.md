...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/beszel:0.15.1 | 20MB | 1000:1000 | ✅ | amd64, arm64 |
...
* [0.15.1](https://hub.docker.com/r/11notes/beszel/tags?name=0.15.1)
* [0.15.1-unraid](https://hub.docker.com/r/11notes/beszel/tags?name=0.15.1-unraid)
...
# REGISTRIES ☁️
```
docker pull 11notes/beszel:0.15.1
docker pull ghcr.io/11notes/beszel:0.15.1
docker pull quay.io/11notes/beszel:0.15.1
```
...
*created 29.10.2025, 06:14:42 (CET)*