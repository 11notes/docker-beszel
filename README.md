...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/beszel:0.15.4 | 20MB | 1000:1000 | ✅ | amd64, arm64 |
...
* [0.15.4](https://hub.docker.com/r/11notes/beszel/tags?name=0.15.4)
* [0.15.4-unraid](https://hub.docker.com/r/11notes/beszel/tags?name=0.15.4-unraid)
...
# REGISTRIES ☁️
```
docker pull 11notes/beszel:0.15.4
docker pull ghcr.io/11notes/beszel:0.15.4
docker pull quay.io/11notes/beszel:0.15.4
```
...
*created 05.11.2025, 06:14:34 (CET)*