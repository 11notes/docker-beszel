...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/beszel:0.14.1 | 20MB | 1000:1000 | ✅ | amd64, arm64 |
...
* [0.14.1](https://hub.docker.com/r/11notes/beszel/tags?name=0.14.1)
* [0.14.1-unraid](https://hub.docker.com/r/11notes/beszel/tags?name=0.14.1-unraid)
...
# REGISTRIES ☁️
```
docker pull 11notes/beszel:0.14.1
docker pull ghcr.io/11notes/beszel:0.14.1
docker pull quay.io/11notes/beszel:0.14.1
```
...
*created 21.10.2025, 07:14:35 (CET)*