...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/beszel:0.15.2 | 20MB | 1000:1000 | ✅ | amd64, arm64 |
...
* [0.15.2](https://hub.docker.com/r/11notes/beszel/tags?name=0.15.2)
* [0.15.2-unraid](https://hub.docker.com/r/11notes/beszel/tags?name=0.15.2-unraid)
...
# REGISTRIES ☁️
```
docker pull 11notes/beszel:0.15.2
docker pull ghcr.io/11notes/beszel:0.15.2
docker pull quay.io/11notes/beszel:0.15.2
```
...
*created 30.10.2025, 06:13:48 (CET)*