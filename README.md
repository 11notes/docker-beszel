...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/beszel:0.15.0 | 20MB | 1000:1000 | ✅ | amd64, arm64 |
...
* [0.15.0](https://hub.docker.com/r/11notes/beszel/tags?name=0.15.0)
* [0.15.0-unraid](https://hub.docker.com/r/11notes/beszel/tags?name=0.15.0-unraid)
...
# REGISTRIES ☁️
```
docker pull 11notes/beszel:0.15.0
docker pull ghcr.io/11notes/beszel:0.15.0
docker pull quay.io/11notes/beszel:0.15.0
```
...
*created 27.10.2025, 06:15:24 (CET)*