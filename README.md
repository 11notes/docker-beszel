...
| henrygd/beszel | 32MB | 1000:1000 | ✅ | amd64, arm64, armv7 |
...
* [0.18.6](https://hub.docker.com/r/11notes/beszel/tags?name=0.18.6)
* [0.18.6-unraid](https://hub.docker.com/r/11notes/beszel/tags?name=0.18.6-unraid)
* [0.18.6-nobody](https://hub.docker.com/r/11notes/beszel/tags?name=0.18.6-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/beszel:0.18.6
docker pull ghcr.io/11notes/beszel:0.18.6
docker pull quay.io/11notes/beszel:0.18.6
```
...
*created 30.03.2026, 08:43:59 (CET)*