...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/beszel:0.15.3 | 20MB | 1000:1000 | ✅ | amd64, arm64 |
...
* [0.15.3](https://hub.docker.com/r/11notes/beszel/tags?name=0.15.3)
* [0.15.3-unraid](https://hub.docker.com/r/11notes/beszel/tags?name=0.15.3-unraid)
...
# REGISTRIES ☁️
```
docker pull 11notes/beszel:0.15.3
docker pull ghcr.io/11notes/beszel:0.15.3
docker pull quay.io/11notes/beszel:0.15.3
```
...
*created 02.11.2025, 06:13:34 (CET)*