...
* [0.18.2](https://hub.docker.com/r/11notes/beszel/tags?name=0.18.2)
...
# REGISTRIES ☁️
```
docker pull 11notes/beszel:0.18.2
docker pull ghcr.io/11notes/beszel:0.18.2
docker pull quay.io/11notes/beszel:0.18.2
```
...
*created 13.01.2026, 06:20:47 (CET)*