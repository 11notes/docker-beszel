...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/beszel:0.14.0 | 20MB | 1000:1000 | ✅ | amd64, arm64 |
...
* [0.14.0](https://hub.docker.com/r/11notes/beszel/tags?name=0.14.0)
* [0.14.0-unraid](https://hub.docker.com/r/11notes/beszel/tags?name=0.14.0-unraid)
...
# REGISTRIES ☁️
```
docker pull 11notes/beszel:0.14.0
docker pull ghcr.io/11notes/beszel:0.14.0
docker pull quay.io/11notes/beszel:0.14.0
```
...
*created 20.10.2025, 07:10:51 (CET)*